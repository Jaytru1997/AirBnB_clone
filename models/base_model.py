#!/usr/bin/python3
"""
Defines a Model class that will be the base for all the classes to be created
in the airbnb module. This class will define all the basics
(attributes and functions) that will be used through out the project by other
class as well
"""
...
class BaseModel:
	...
	def __init__(self, *args, **kwargs):
		"""
		initialises the public attributes of the instance after creation

		Args:
		*args: variable number of arguments passed into our function
		**kwargs: named variable arguments having Key/Value
		"""
